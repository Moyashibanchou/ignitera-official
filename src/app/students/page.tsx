                ...
                <section className="mb-32 relative">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
                        <StepCard
                            ...
                            title="案件を獲得・遂行する"
                            description={<>実践的なプロジェクトに参画し、<br className="hidden md:block" />報酬を得ながらスキルを磨く。<br className="hidden md:block" />あなたの行動がすべての出発点。</>}
                            delay={0.1}
                        />
                        <StepCard
                            number="02"
                            icon={<Zap className="w-10 h-10 text-cyan-400" />}
                            title={<>運営とチームの双方向評価で<br />実績がデータ化される</>}
                            description={<>関わったメンバーと運営からの<br className="hidden md:block" />360度評価により、あなたの<br className="hidden md:block" />「見えない強み」が客観的な<br className="hidden md:block" />スコアに変換される。</>}
                            delay={0.3}
                        />
                        <StepCard
                            number="03"
                            icon={<Database className="w-10 h-10 text-fuchsia-400" />}
                            title={<>蓄積されたデータが<br />最強のポートフォリオに</>}
                            description={<>45項目のステータスが<br className="hidden md:block" />あなたの価値を明確に証明。<br className="hidden md:block" />優良企業からのスカウトや、<br className="hidden md:block" />より高単価な案件へと繋がる。</>}
                            delay={0.5}
                        />
                    </div>
                </section>
