...
import { Activity, BookOpen, Clock, Code2, GitMerge, GitPullRequest, Layers, MessageSquare, ShieldCheck, Target, Terminal, UploadCloud, Users, Zap, Search, MonitorPlay } from "lucide-react";
