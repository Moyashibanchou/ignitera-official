                            ...
                            >
                                ...
                                <div className="relative w-16 h-16 flex items-center justify-center mb-6">
                                    ...
                                    >
                                        ...
                                        {/* Minimalist Flame Icon (Phase 1) */}
                                        <motion.svg
                                            width="32" height="32" viewBox="0 0 24 24" fill="none"
                                            className="absolute text-[#FF4D00] drop-shadow-[0_0_12px_rgba(255,77,0,0.8)]"
                                            initial={{ scale: 0.5, y: 10, opacity: 0 }}
                                            animate={phase >= 1 ? { scale: 1, y: 0, opacity: 1 } : { scale: 0.5, y: 10, opacity: 0 }}
                                            transition={bouncySpring}
                                        >
                                            <path
                                ...
                                <div className="h-8 overflow-hidden flex items-center justify-center">
                                    <AnimatePresence>
                                        {phase >= 1 && (
                                            <motion.p
                                                className="text-white/90 font-mono text-sm tracking-[0.3em] uppercase"
                                                initial={{ y: 20, opacity: 0, letterSpacing: "1em", textShadow: "0px 0px 0px rgba(255,77,0,0)" }}
                                                animate={{ y: 0, opacity: 1, letterSpacing: "0.3em", textShadow: "0px 0px 12px rgba(255,77,0,0.6)" }}
